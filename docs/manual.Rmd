...
-v | \-\-var | Output variables [optional; default= default=`NULL`]
...
The following commandline will compare various ephemerides and recover Figure 9 in the paper. 
```
...
<center>
![](../results/PSRJ0740+6620_shapiro.png)
...
<center>
![](../results/HD197461_orbit.png){width=350px}
![](../results/HD197461_P8.png){width=250px}
