...
## $\delta$ Del (HD197461)
$\delta$ Del has a well-determined orbit based on astrometric and RV data from [Gardner et al. 2018](https://arxiv.org/pdf/1802.00468.pdf). By using the following commandline, one can reproduce the binary orbit. 
