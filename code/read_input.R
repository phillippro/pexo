option_list  <-  list(
    ...
    make_option(c("-t", "--time"), type="character", default='2450000 2460000 100 HARPS',help='Timing file: epochs or times could be in 1-part or 2-part JD[UTC] format [mandatory if mode=emulate]'),
    make_option(c("-p", "--primary"), type="character", default='HD10700',help='primary star name [mandatory]'),
...
####
cat('\nLoading ephermies and EOP and other auxiliary data!\n')
source('load_data.R')
